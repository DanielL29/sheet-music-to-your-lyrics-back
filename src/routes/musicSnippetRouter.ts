...
musicSnippetRouter.post('/:musicName/create', validateToken, validateTeacher, upload.single('snippetAid'), validateSchemas('musicSnippet'), musicSnippetController.insert);
